...
if (typeof gdjs.evtsExt__Backpack__Function !== "undefined") {
  gdjs.evtsExt__Backpack__Function.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__Backpack__Function = {};
gdjs.evtsExt__Backpack__Function.idToCallbackMap = new Map();


gdjs.evtsExt__Backpack__Function.userFunc0x1017a78 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
"use strict";
...
async function connectBackpack() {
  try {
    ...
    window.parent.postMessage({ type: 'shinigami-wallet-request', walletType: 'backpack' }, '*');
...
gdjs.evtsExt__Backpack__Function.eventsList0 = function(runtimeScene, eventsFunctionContext) {

{


gdjs.evtsExt__Backpack__Function.userFunc0x1017a78(runtimeScene, eventsFunctionContext);
...
gdjs.evtsExt__Backpack__Function.func = function(runtimeScene, parentEventsFunctionContext) {
...
var eventsFunctionContext = {
  ...
  globalVariablesForExtension: runtimeScene.getGame().getVariablesForExtension("Backpack"),
  sceneVariablesForExtension: runtimeScene.getScene().getVariablesForExtension("Backpack"),
  localVariables: [],
...
gdjs.evtsExt__Backpack__Function.eventsList0(runtimeScene, eventsFunctionContext);


return;
}

gdjs.evtsExt__Backpack__Function.registeredGdjsCallbacks = [];