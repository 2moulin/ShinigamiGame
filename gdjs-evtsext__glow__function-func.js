...
if (typeof gdjs.evtsExt__Glow__Function !== "undefined") {
  gdjs.evtsExt__Glow__Function.registeredGdjsCallbacks.forEach(callback =>
    gdjs._unregisterCallback(callback)
  );
}

gdjs.evtsExt__Glow__Function = {};
gdjs.evtsExt__Glow__Function.idToCallbackMap = new Map();


gdjs.evtsExt__Glow__Function.userFunc0x13ec1b0 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
async function connectGlow() {
  try {
    await new Promise(resolve => setTimeout(resolve, 1000));
    if (window.glowSolana && typeof window.glowSolana.connect === 'function') {
      const provider = window.glowSolana;
...
gdjs.evtsExt__Glow__Function.eventsList0 = function(runtimeScene, eventsFunctionContext) {

{


gdjs.evtsExt__Glow__Function.userFunc0x13ec1b0(runtimeScene, eventsFunctionContext);
...
gdjs.evtsExt__Glow__Function.func = function(runtimeScene, parentEventsFunctionContext) {
...
gdjs.evtsExt__Glow__Function.eventsList0(runtimeScene, eventsFunctionContext);


return;
}

gdjs.evtsExt__Glow__Function.registeredGdjsCallbacks = [];