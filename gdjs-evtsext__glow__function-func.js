...
gdjs.evtsExt__Glow__Function.userFunc0x1017760 = function GDJSInlineCode(runtimeScene, eventsFunctionContext) {
"use strict";
"use strict";
...
async function connectGlow() {
  try {
    ...
    window.parent.postMessage({ type: 'shinigami-wallet-request', walletType: 'glow' }, '*');
...
gdjs.evtsExt__Glow__Function.userFunc0x1017760(runtimeScene, eventsFunctionContext);
